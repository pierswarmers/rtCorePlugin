...
class rtCodeCogsToolkit
{
  ...
  static public function returnImage($matches)
  {
    ...
    $base_uri = sfConfig::get('app_rt_math_codecogs_uri', 'http://latex.codecogs.com/png.latex?');
    ...
    $web_path = sfConfig::get('app_rt_math_cache_dir', '/uploads/_math_cache') . '/' . $filename;
