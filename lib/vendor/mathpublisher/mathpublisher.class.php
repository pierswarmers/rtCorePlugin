...
/**
 * Static class for handling common configurables.
 */
class mathPublisherConfig
{
  static public function getFontDir()
  {
  ...
  static public function getFontsmath()
  {
    $fontesmath = array(
            '~'=>'FreeSerif',
            'alpha'=>'cmmi10',
...
{
  $fontesmath = mathPublisherConfig::getFontsmath();
  $symboles = mathPublisherConfig::getSymbols();
  $dirfonts = mathPublisherConfig::getFontDir();
