...
<?php end_slot(); ?>
  ...
  <table cellspacing="0">
    ...
    <tfoot>
      <tr>
        <td>
          <form id="<?php echo strtolower($model);?>_root_create" action="<?php echo url_for('gnTreeAdmin/Add_root');?>" method="post">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <ul class="gn-admin-tools">
            <li><?php echo gn_ui_button(__('Open this tree'), $sf_request->getParameter('module') . '/' . $sf_request->getParameter('action') . '?root=' . $root->id, 'arrow-1-e') ?></li>
          </ul>
        </td>
      </tr>
      <?php endforeach; ?>
