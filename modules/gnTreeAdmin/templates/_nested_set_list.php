	...
	$("#<?php echo strtolower($model);?>-nested-set").tree({
  	plugins : { 
			...
			onrename : function (NODE, TREE_OBJ, RB) {
                ...
                if (TREE_OBJ.get_text(NODE) == 'New folder'){
                    ...
                    if (NODE.id == ''){ // happen if creation of a new node
                        $.ajax({
                            type: "POST",
                            url : '<?php echo url_for('gnTreeAdmin/Add_child');?>',
                            dataType : 'json',
						...
						$.ajax({
							type: "POST",
							url : '<?php echo url_for('gnTreeAdmin/Edit_field');?>',
							dataType : 'json',
        ...
        //alert('Moving to: ' + REF_NODE.id.replace('phtml_',''));
				...
				$.ajax({
					type: "POST",
					url : '<?php echo url_for('gnTreeAdmin/Move');?>',
					dataType : 'json',
			...
			ondelete: function(NODE, TREE_OBJ, RB){
				...
				$.ajax({
					type: "POST",
					url : '<?php echo url_for('gnTreeAdmin/Delete');?>',
					dataType : 'json',
