...
class Tester extends Doctrine_Record
{
    ...
    {
      parent::setUp();
      $search = new gnSearchTemplate(array('fields' =>array('title','content')));
      $this->actAs($search);
    }
}
...
Doctrine_Core::createTablesFromArray(array('Tester', 'GnIndex'));
...
class I18nTester extends Doctrine_Record
{
    ...
    public function setUp()
    {
      ...
      $this->actAs(new gnSearchTemplate);
      $this->actAs($i18n);
    }
...
$index_items = Doctrine::getTable('gnIndex')->getQueryObject()
      ->from('gnIndex i')
